 ...
 */
@ResourceDef(name="Patient", profile="http://http://fhir.dataqhealth.com/fhir/StructureDefinition/mypatient")
...
public class CustomPatient extends Patient {
     ...
     */
    @Child(name="petName")
    @Extension(url="http://fhir.dataqhealth.com/fhir/dontuse#petname", definedLocally=false, isModifier=false)
    ...
    @Extension(url="http://fhir.dataqhealth.com/fhir/dontuse#importantDates", definedLocally=false, isModifier=true)
